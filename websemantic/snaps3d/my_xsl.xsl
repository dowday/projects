...
<!--<xsl:template match="city:CityModel">  &lt;!&ndash; text nodes are ignored &ndash;&gt;-->

    <!-- First i Extract Road and we see it in the browser  -->
		<!--<xsl:for-each select="city:cityObjectMember/trans:Road/trans:lod3MultiSurface/gml:MultiSurface/gml:surfaceMember/gml:Polygon/gml:exterior/gml:LinearRing">-->
			<!--<shape>-->
				<!--<IndexedFaceSet>-->
					...
					<!--<!-&#45;&#45; string-length(translate(normalize-space(gml:posList),' ','')) +1"/>&ndash;&gt;-->
